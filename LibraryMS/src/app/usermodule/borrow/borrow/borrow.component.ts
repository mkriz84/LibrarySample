...
export class BorrowComponent implements OnInit {
  ...
  constructor(private router: Router ,private bookSer: AdminBooksService, private userDet: UserOwnedService, private memberSer: AdminMembersService, ) {
  ...
  getbyStatus(fil: string) {
    console.log(fil);
    this.bookSer.getBooks(fil)
      .subscribe(data => this.books = data);
  }



  SelectedBook( id : string,Bookname:string){
